var OrgChart = function(t, e) {
    ...
    this._event_id = OrgChart._guid(), OrgChart._validateConfig(this.config) && (this._vScroll = {}, this.config.ui || (this.ui = OrgChart.ui), this.config.editUI ? this.editUI = this.config.editUI : this.editUI = new OrgChart.editUI, this.editUI.init(this), this.config.filterUI ? this.filterUI = this.config.filterUI : this.filterUI = new OrgChart.filterUI, this.filterUI.init(this), this.manager = new OrgChart.manager(this), this.config.searchUI ? this.searchUI = this.config.searchUI : this.searchUI = new OrgChart.searchUI, this.config.nodeMenuUI ? this.nodeMenuUI = this.config.nodeMenuUI : this.nodeMenuUI = new OrgChart.menuUI, this.nodeMenuUI.init(this, this.config.nodeMenu), this.config.nodeCircleMenuUI ? this.nodeCircleMenuUI = this.config.nodeCircleMenuUI : this.nodeCircleMenuUI = new OrgChart.circleMenuUI, this.nodeCircleMenuUI.init(this, this.config.nodeCircleMenu), this.config.nodeContextMenuUI ? this.nodeContextMenuUI = this.config.nodeContextMenuUI : this.nodeContextMenuUI = new OrgChart.menuUI, this.nodeContextMenuUI.init(this, this.config.nodeContextMenu), this.config.toolbarUI ? this.toolbarUI = this.config.toolbarUI : this.toolbarUI = new OrgChart.toolbarUI, this.config.notifierUI ? this.notifierUI = this.config.notifierUI : this.notifierUI = new OrgChart.notifierUI, this.notifierUI.init(this), this.config.menuUI ? this.menuUI = this.config.menuUI : this.menuUI = new OrgChart.menuUI, this.menuUI.init(this, this.config.menu), this.config.xScrollUI || (this.xScrollUI = new OrgChart.xScrollUI(this.element, this.config, (function() {
        ...
        r._draw(!0, OrgChart.action.xScroll)
    }))), this.config.undoRedoUI ? this.undoRedoUI = this.config.undoRedoUI : this.undoRedoUI = new OrgChart.undoRedoUI, this.element.classList.add("boc-" + this.config.mode), this._gragStartedId = null, this._timeout = null, this._touch = null, this._initialized = !1, this._loaded = !1, this._moveInterval = null, this._movePosition = null, this.response = null, this.nodes = null, this.isVisible = null, OrgChart._intersectionObserver(this.element, (function(t) {
...
OrgChart._defaultConfig = function(t) {
                ...
                if (!a.notifierUI.show(t.notif)) {
                    ...
                    if (OrgChart.RENDER_LINKS_BEFORE_NODES)
                        for (var c = 0; c < t.visibleNodeIds.length; c++) {
                            ...
                            OrgChart.getRootOf(g).stParent ? d.push(g.id) : o += a.ui.link(g, a, l, t.bordersByRootIdAndLevel, t.nodes, e)
                        }
                    for (c = 0; c < t.visibleNodeIds.length; c++) {
                        g = t.nodes[t.visibleNodeIds[c]];
                        var p = a._get(g.id);
                        OrgChart.RENDER_LINKS_BEFORE_NODES && d.includes(g.id) && (o += a.ui.link(g, a, l, t.bordersByRootIdAndLevel, t.nodes, e)), o += a.ui.node(g, p, t.animations, a.config, void 0, void 0, void 0, e, l, a)
                    }
                    for (c = 0; c < t.visibleNodeIds.length; c++) {
                        g = t.nodes[t.visibleNodeIds[c]];
                        OrgChart.RENDER_LINKS_BEFORE_NODES || (o += a.ui.link(g, a, l, t.bordersByRootIdAndLevel, t.nodes, e)), o += a.ui.expandCollapseBtn(a, g, a._layoutConfigs, e, l)
                    }
                    n = {
                        content: o,
                        res: t
                    ...
                    if (OrgChart.events.publish("render", [a, n]), o = n.content, t = n.res, o += a.ui.lonely(a.config), e !== OrgChart.action.exporting) {
                        ...
                        if (a._initialized) {
                            var u = a.getSvg(),
                                f = u.parentNode;
                            f.removeChild(u), f.insertAdjacentHTML("afterbegin", y), a._attachEventHandlers(), a.xScrollUI.addListener(a.getSvg()), a.yScrollUI.addListener(a.getSvg()), a.xScrollUI.setPosition(), a.yScrollUI.setPosition()
                        ...
                        if (C[0].length > 0) {
                            ...
                            for (c = 0; c < C[0].length; c++) C[0][c] = a.getNodeElement(C[0][c]);
                            OrgChart.animate(C[0], C[1], C[2], a.config.anim.duration, a.config.anim.func, (function() {
                                m || (i && i(), OrgChart.events.publish("redraw", [a]), a._showAfterAnimation(), m = !0)
                            }))
                        }
                        e === OrgChart.action.centerNode ? OrgChart.animate(a.getSvg(), {
                            ...
                            a.ripple(r.options.rippleId), m || (i && i(), OrgChart.events.publish("redraw", [a]), a._showAfterAnimation(), m = !0)
                        }), (function() {
                            ...
                            a.xScrollUI.setPosition(), a.yScrollUI.setPosition(), m || (i && i(), OrgChart.events.publish("redraw", [a]), m = !0)
    ...
    if (null != i) {
        ...
        if (null != a) {
            ...
            OrgChart.events.publish("ripple", [this, b]), m.setAttribute("x", b.ripple.rect ? b.ripple.rect.x : 0), m.setAttribute("y", b.ripple.rect ? b.ripple.rect.y : 0), m.setAttribute("width", b.ripple.rect ? b.ripple.rect.width : i.w), m.setAttribute("height", b.ripple.rect ? b.ripple.rect.height : i.h), m.setAttribute("rx", b.ripple.radius), m.setAttribute("ry", b.ripple.radius), C.setAttribute("clip-path", "url(#" + O + ")"), C.setAttribute("cx", o), C.setAttribute("cy", l), C.setAttribute("r", 0), C.setAttribute("fill", b.ripple.color), C.setAttribute("class", "boc-ripple"), f.appendChild(m), u.appendChild(f), u.appendChild(C), a.appendChild(u), OrgChart.animate(C, {
                r: 0,
                opacity: 1
            }, {
                r: p,
    ...
    var i = this;
    e || (e = "base"), this._layoutConfigs[e].orientation = t, "base" == e && (this.config.orientation = t), this._draw(!1, OrgChart.action.update, void 0, (function() {
    ...
    for (var r = this, i = this.getSvg(), a = this.getViewBox(), n = null, o = null, l = null, s = null, h = 0; h < t.length; h++) {
        var d = this.nodes[t[h]];
        (null === n || n < d.x + d.w) && (n = d.x + d.w), (null === o || o < d.y + d.h) && (o = d.y + d.h), (null === l || l > d.x) && (l = d.x), (null === s || s > d.y) && (s = d.y)
    }
    var c = this.width(),
        g = this.height(),
    ...
    if (m - 2 * this.config.padding >= n - l) O = (n + l) / 2 - m / 2;
    else switch (O = firstRoot.x - m / 2 + OrgChart.manager._getNodeWidth(firstRoot, this.config) / 2, this.config.orientation) {
        case OrgChart.orientation.right:
        case OrgChart.orientation.right_top:
            (O = -(m / 2 - (l - n) / 2)) < this.config.padding - m && (O = this.config.padding - m);
            break;
        ...
        case OrgChart.orientation.left_top:
            (O = -(m / 2 - (n - l) / 2)) > -this.config.padding && (O = -this.config.padding)
    }
    if (C - 2 * this.config.padding >= o - s) b = (o + s) / 2 - C / 2;
    else switch ((b = -(C / 2 - (o - s) / 2)) > -this.config.padding && (b = -this.config.padding), this.config.orientation) {
        case OrgChart.orientation.bottom:
        case OrgChart.orientation.bottom_left:
            (b = -(C / 2 - (s - o) / 2)) < this.config.padding - C && (b = this.config.padding - C);
            break;
        case OrgChart.orientation.left:
        case OrgChart.orientation.right:
            b = firstRoot.y - C / 2 + OrgChart.manager._getNodeWidth(firstRoot, this.config) / 2
    }
    var v = [O, b, m, C];
    a[0] !== v[0] || a[1] !== v[1] ? OrgChart.animate(i, {
        viewBox: a
    }, {
        viewBox: v
    ...
    return this.remove(t), OrgChart.events.publish("updated", [this]), this.filterUI.update(), this._draw(!1, OrgChart.action.update, null, (function() {
    ...
    this.add(t), OrgChart.events.publish("updated", [this]), this.filterUI.update(), i._draw(!1, OrgChart.action.insert, {
        id: t.pid,
        insertedNodeId: t.id
    }, (function() {
        i.ripple(t.id), e && e()
    ...
    if (null == t.id && console.error("Call addNode without id"), this._putInUndoStack(), this.clearRedo(), this.config.movable && !OrgChart.isNEU(t.pid)) {
    ...
    if (Array.isArray(this.config.roots))
        for (r = 0; r < this.config.roots.length; r++) OrgChart.isNEU(t[this.config.roots[r]]) || (this.config.roots[r] = t[this.config.roots[r]]);
    if (this.nodes)
                ...
                switch (g.toLowerCase()) {
                    ...
                    case "rotate3d":
                        if (r[c][g]) {
                            var C = e[c][g],
                                O = r[c][g],
                                b = [0, 0, 0, 0];
                            for (var v in C) b[v] = a((h * s - s) / i) * (O[v] - C[v]) + C[v];
                    ...
                    case "transform":
                        if (r[c][g]) {
                            ...
                            for (var v in C) b[v] = a((h * s - s) / i) * (O[v] - C[v]) + C[v];
                            t[c].hasAttribute("transform") ? t[c].setAttribute("transform", "matrix(" + b.toString() + ")") : t[c].style.transform = "matrix(" + b.toString() + ")"
                        }
                        break;
                    case "viewbox":
                        if (r[c][g]) {
    ...
    this.obj.element.appendChild(a.element), OrgChart.input.init(this.obj.element), OrgChart.events.publish("shown", [this, {
        nodeId: t
    }]), r ? e || this._focusElement(a.focusId) : this.interval = OrgChart.animate(a.element, {
        right: -20,
        opacity: 0
    }, {
        right: 0,
    ...
    for (var s in a = l.menu) {
        var h = a[s].icon,
            d = a[s].text;
        void 0 === h && (h = OrgChart.icon[s] ? OrgChart.icon[s](24, 24, "#7A7A7A") : ""), "function" == typeof d && (d = d()), "function" == typeof h && (h = h()), o += "<div " + OrgChart.attr.item + '="' + s + '">' + h + "<span>&nbsp;&nbsp;" + d + "</span></div>"
    }
    if ("" != o) {
    ...
    if (!OrgChart.isNEU(a.nodeCircleMenuButton)) {
        ...
        if (OrgChart.isNEU(p) || p.getAttribute(OrgChart.attr.control_node_circle_menu_wrraper_id) != t) {
            ...
            for (var m = 0, C = Object.keys(u.menu).length, O = 2 * a.nodeCircleMenuButton.radius + 4, b = 2 * Math.PI * O, v = b / C - (2 * a.nodeCircleMenuButton.radius + 2); v < 0;) O += 8, v = (b = 2 * Math.PI * O) / C - (2 * a.nodeCircleMenuButton.radius + 2);
            for (var y in (p = document.createElementNS("http://www.w3.org/2000/svg", "g")).setAttribute(OrgChart.attr.control_node_circle_menu_wrraper_id, t), p.setAttribute("transform", "matrix(1,0,0,1," + d + "," + c + ")"), n.appendChild(p), u.menu) {
                var x = u.menu[y].icon,
                    _ = u.menu[y].color,
                    w = u.menu[y].text;
        ...
        r && r.addEventListener("click", (function() {
            ...
            for (var e = t.target; e;) {
                if (e.hasAttribute && e.hasAttribute(OrgChart.attr.layout)) {
                    e = e.getAttribute(OrgChart.attr.layout), l.obj.setLayout(OrgChart.layout[e]);
                    break
                }
                e = e.parentNode
            }
...
}, void 0 === OrgChart && (OrgChart = {}), OrgChart.icon = {}, OrgChart.icon.png = function(t, e, r) {
    ...
    t.margin && t.margin[0] < 2 && (t.margin[0] = 2), t.margin && t.margin[1] < 2 && (t.margin[1] = 2), t.margin && t.margin[2] < 2 && (t.margin[2] = 2), t.margin && t.margin[3] < 2 && (t.margin[3] = 2), this._draw(!1, OrgChart.action.exporting, i, (function(i, a) {
        var n = document.createElement("div");
        if (n.innerHTML = i, t.padding > 0) {
            var o = n.querySelector("svg"),
                l = OrgChart._getViewBox(o);
            l[0] -= t.padding, l[1] -= t.padding, l[2] += 2 * t.padding, l[3] += 2 * t.padding, o.setAttribute("viewBox", l.join()), o.setAttribute("width", l[2]), o.setAttribute("height", l[3])
        }
        if ("svg" == t.ext)
            if (e) e(t, n.innerHTML);
                ...
                if (d && (s.styles += d.outerHTML), s.styles && (n.childNodes[0].insertAdjacentHTML("afterbegin", s.styles), s.content = n.innerHTML), !1 === h) return !1;
                if (!1 === (h = OrgChart.events.publish("exportend", [r, s]))) return !1;
                OrgChart._downloadFile(t.mime, s.content, s.options.filename, s.options.openInNewTab, s.options.ext)
            }
        else r._pages(t, n.querySelector("svg"), a, (function(i) {
            var a = {
                    content: n.innerHTML,
                    options: t,
                    pages: i,
            ...
            e || OrgChart.loading.show(r), e ? e(r, a, n.querySelector("svg")) : (a = JSON.stringify(a), OrgChart._ajax(r.config.exportUrl + "/v3", "POST", a, "arraybuffer", (function(e) {
    ...
    if (Array.isArray(e))
        for (var a = 0; a < e.length; a++) OrgChart._exportIterateForJSON_XML_CSV(t, e[a], r, i);
    else {
        var n = t.get(e.id);
        if (i.push(n), r.min)
            for (a = 0; a < e.stChildrenIds.length; a++) OrgChart._exportIterateForJSON_XML_CSV(t, t.getNode(e.stChildrenIds[a]), r, i);
        else
            for (a = 0; a < e.stChildren.length; a++) OrgChart._exportIterateForJSON_XML_CSV(t, e.stChildren[a], r, i);
        if (r.expandChildren)
            for (a = 0; a < e.childrenIds.length; a++) OrgChart._exportIterateForJSON_XML_CSV(t, t.getNode(e.childrenIds[a]), r, i);
        else
            for (a = 0; a < e.children.length; a++) OrgChart._exportIterateForJSON_XML_CSV(t, e.children[a], r, i)
    }
}, OrgChart.prototype._pages = function(t, e, r, i) {
    "A5" == t.format && "fit" != t.scale || "A4" == t.format && "fit" != t.scale || "A3" == t.format && "fit" != t.scale || "A2" == t.format && "fit" != t.scale || "A1" == t.format && "fit" != t.scale || "Letter" == t.format && "fit" != t.scale || "Legal" == t.format && "fit" != t.scale ? i(this._pagesA100(t, e, t.scale)) : "A5" == t.format && "fit" == t.scale || "A4" == t.format && "fit" == t.scale || "A3" == t.format && "fit" == t.scale || "A2" == t.format && "fit" == t.scale || "A1" == t.format && "fit" == t.scale || "Letter" == t.format && "fit" == t.scale || "Legal" == t.format && "fit" == t.scale ? i(this._pagesAfit(t, e, r)) : "fit" == t.format && i(this._pagesFit(t, e))
    ...
    var o = t.landscape ? n - (t.margin[1] + t.margin[3]) : a - (t.margin[1] + t.margin[3]),
        l = (t.landscape ? (t.margin[0], t.margin[2]) : (t.margin[0], t.margin[2]), o / i);
    ...
    if (!OrgChart.EXPORT_PAGES_CUT_NODES && "fit" == t.scale) {
        ...
        for (var b = Object.keys(i.bordersByRootIdAndLevel), v = i.bordersByRootIdAndLevel[b[0]], y = Object.keys(v).length, x = 1; x < b.length; x++) y < Object.keys(i.bordersByRootIdAndLevel[b[x]]).length && (v = i.bordersByRootIdAndLevel[b[x]], y = Object.keys(v).length);
        for (var _ = 0, w = 0;;) {
            for (w = _; !(y <= _);) {
                ...
                if (_ == y - 1 && (k = (v[_].maxY - v[w].minY) / (100 / r)), k > c.h) break;
                _++
            }
            if (!O) break;
            ...
            if (I = (I = [f, v[w].minY, p, S]).join(), C.push({
                    vb: I,
                    innerSize: {
                        w: c.x,
                        h: S / (100 / r) - 1
    ...
    if (!O || OrgChart.EXPORT_PAGES_CUT_NODES || "fit" != t.scale)
        for (e.setAttribute("preserveAspectRatio", "xMinYMin slice"), C = []; f < h + l;) {
            for (; m < d + s;) {
                var I;
                I = (I = [f, m, p, u]).join(), C.push({
                    vb: I,
                    innerSize: c,
                    size: g
                }), m += u
    ...
    var n = {
        ...
        l = this.editUI.content(t.nodeId, !0, !0, "100%", !0).element;
    ...
    return {
        ...
        remove: function(e, r, i) {
            ...
            if (t[e] && Array.isArray(t[e]) && t[e].length > 0)
                for (var n = t[e].length - 1; n >= 0; n--)(!OrgChart.isNEU(i) && !OrgChart.isNEU(r) && t[e][n].event_id == i && t[e][n].listener == r || !OrgChart.isNEU(i) && OrgChart.isNEU(r) && t[e][n].event_id == i || OrgChart.isNEU(i) && !OrgChart.isNEU(r) && t[e][n].listener == r || OrgChart.isNEU(i) && OrgChart.isNEU(r)) && (t[e].splice(n, 1), a = !0);
            return a
        },
        has: function(e, r) {
            if (t[e] && Array.isArray(t[e]) && t[e].length > 0) {
    ...
    if (-1 == t.indexOf("id") || -1 == t.indexOf("pid")) {
        ...
        d.setAttribute("for", "boc-id-select"), d.appendChild(c), d.style.fontSize = "16px", d.style.color = "rgb(122, 122, 122)", d.style.padding = "5px", d.style.margin = "5px", d.style.width = "30%", d.style.textAlign = "right", d.style.display = "inline-block", r.appendChild(d);
    ...
    this._resetMovableNodes(), Array.isArray(e) || (e = []), Array.isArray(r) || (r = []);
    var a = {
        id: t,
        expandIds: e,
        collapseIds: r,
    ...
    if (OrgChart.RESET_MOVABLE_ONEXPANDCOLLAPSE && null != this.config.movable) {
        for (var t = !1, e = 0; e < this.config.nodes.length; e++) {
            var r = this.config.nodes[e];
            null != r.movex && (r.movex = 0, t = !0), null != r.movey && (r.movey = 0, t = !0)
        }
    ...
    if (n.draggable) {
        ...
        var b = function(t, e) {
            ...
            v = function(e) {
                if (p) {
                    ...
                    if (s.left || s.right || s.up || s.down) {
                        ...
                        for (o.moveEnd(), g.classList && (g.classList.add("boc-cursor-grab"), g.classList.remove("boc-cursor-move"), g.classList.remove("boc-cursor-nodrop"), g.classList.remove("boc-cursor-copy")), b(d, c), d = null, c = null; null != i && i != g;) {
            ...
            y = function(e) {
                if (o.moveEnd(), g.classList && (g.classList.remove("boc-cursor-grab"), g.classList.remove("boc-cursor-move"), g.classList.remove("boc-cursor-nodrop"), g.classList.remove("boc-cursor-copy")), g.removeEventListener(r.move, v), g.removeEventListener(r.up, y), r.leave && g.removeEventListener(r.leave, y), s.id == d || null == d) return g.removeChild(u), o._gragStartedId = null, void(t._dragEventFired && OrgChart.events.publish("drop", [o.nodeCircleMenuUI, {
                    from: s.id,
                    menuItemName: a,
                    menuItem: n,
                    event: e
                ...
                OrgChart.events.publish("drop", [o.nodeCircleMenuUI, {
                    ...
                    menuItemName: a,
                    event: e
                }]), b(d, c), g.removeChild(u), o._gragStartedId = null
            };
    ...
    var i = t.getAttribute(OrgChart.attr.node_id),
        a = this.getNode(i);
    this.config.movable && !OrgChart.getRootOf(a).stParent ? this._movableHandler(t, e, r) : this.config.enableDragDrop && this._dragDropHandler(t, e, r)
    ...
    var i = this,
        ...
        o = function(t, e) {
            if (Array.isArray(t))
                for (var r = 0; r < t.length; r++) o(t[r], e);
            else {
                e.push(t.id);
        ...
        l = function(t, e) {
            if (Array.isArray(t))
                ...
                e.push(t.id);
                for (r = 0; r < t.stChildrenIds.length; r++) l(i.getNode(t.stChildrenIds[r]), e);
                for (r = 0; r < t.childrenIds.length; r++) l(i.getNode(t.childrenIds[r]), e)
            }
        },
        s = this.getNode(a);
    o(s, n);
    for (var h = this.getSvg(), d = OrgChart._getClientXY(e), c = [], g = [], p = [], u = [], f = [], m = [], C = [], O = [], b = 0; b < n.length; b++) {
    ...
    var k = null,
        S = null;
    this._gragStartedId = n[0], document.body.style.mozUserSelect = document.body.style.webkitUserSelect = document.body.style.userSelect = "none";
    var I = {
            x: d.x,
            y: d.y
        },
        ...
        L = function(t, e) {
            if (null != t) {
                e.classList.remove("boc-drag-over");
                for (var r = i.getNode(k), a = OrgChart.getStParentNodes(r), n = 0; n < a.length; n++) {
        ...
        N = function(e) {
            if (I) {
                ...
                if (d.left || d.right || d.up || d.down) {
                    ...
                    for (var b = [], v = [], y = [], x = [], _ = 0; _ < g.length; _++) b.push(g[_][4]), v.push(g[_][5]), C[_] ? (y.push(C[_][4]), x.push(C[_][5])) : (y.push(null), x.push(null));
                    var w = I.x,
                        N = I.y,
                        M = r.x,
                        T = r.y;
                    i.moveStart(d, (function(t) {
                        for (var e = 0; e < g.length; e++) {
                            var a = b[e],
                                ...
                                o = y[e],
                                l = x[e];
                            g[e][4] = a + t.x, g[e][5] = n + t.y, I.x = w - t.xWithoutScale, I.y = N - t.yWithoutScale, r.x = M - t.xWithoutScale, r.y = T - t.yWithoutScale, c[e].x = a + t.x, c[e].y = n + t.y, c[e].movex = t.x, c[e].movey = t.y, C[e] && (C[e][4] = o + t.x, C[e][5] = l + t.y);
                            for (var s = OrgChart.ui.link(c[e], i, A, i.response.bordersByRootIdAndLevel, i.nodes, OrgChart.action.update, !0), h = 0; h < s.length; h++) {
                                var d = s[h];
                                (p = i.element.querySelector(`[data-l-id="[${d.id}][${d.childId}]"]`)) && (p.innerHTML = d.html)
                            }
                            if (c[e].parent)
                                for (s = OrgChart.ui.link(c[e].parent, i, A, i.response.bordersByRootIdAndLevel, i.nodes, OrgChart.action.update, !0), h = 0; h < s.length; h++) {
                                    var p;
                                    d = s[h];
                                    (p = i.element.querySelector(`[data-l-id="[${d.id}][${d.childId}]"]`)) && (p.innerHTML = d.html)
                                }
                            f[e].setAttribute("transform", "matrix(" + g[e].toString() + ")"), m[e] && m[e].setAttribute("transform", "matrix(" + C[e].toString() + ")")
                        }
                    }))
                } else {
                    if (i.moveEnd(), h.classList && (h.classList.add("boc-cursor-grab"), h.classList.remove("boc-cursor-move"), h.classList.remove("boc-cursor-nodrop"), h.classList.remove("boc-cursor-copy")), L(k, S), k = null, S = null, i.config.enableDragDrop)
                        for (; null != o && o != h;) {
                    ...
                    if (null != k) {
                        ...
                        for (var U = i.getNode(k), R = OrgChart.getStParentNodes(U), P = 0; P < R.length; P++) {
                            var F = i.getNodeElement(R[P].id);
                            F && (F.style.opacity = .1)
                        }!i.canUpdateLink(c[0].id, k) && h.classList ? (h.classList.remove("boc-cursor-grab"), h.classList.remove("boc-cursor-move"), h.classList.remove("boc-cursor-copy"), h.classList.add("boc-cursor-nodrop")) : h.classList && (h.classList.remove("boc-cursor-grab"), h.classList.remove("boc-cursor-move"), h.classList.add("boc-cursor-copy"), h.classList.remove("boc-cursor-nodrop"))
                    }
                    var H = (r.x - I.x) / A,
                        D = (r.y - I.y) / A;
                    for (_ = 0; _ < g.length; _++) {
                        g[_][4] = u[_].x + H, g[_][5] = u[_].y + D, C[_] && (C[_][4] = O[_].x + H, C[_][5] = O[_].y + D), c[_].x = p[_].x + H, c[_].y = p[_].y + D, c[_].movex = H, c[_].movey = D;
                        var z = OrgChart.ui.link(c[_], i, A, i.response.bordersByRootIdAndLevel, i.nodes, OrgChart.action.update, !0);
                        for (P = 0; P < z.length; P++) {
                            var j = z[P];
                            (Y = i.element.querySelector(`[data-l-id="[${j.id}][${j.childId}]"]`)) && (Y.innerHTML = j.html)
                        }
                    }
                    if (s.parent)
                        if (i.config.movable == OrgChart.movable.detachTree)(Y = i.element.querySelector(`[data-l-id="[${s.parent.id}][${s.id}]"]`)) && Y.parentElement.removeChild(Y);
                        else
                            for (z = OrgChart.ui.link(s.parent, i, A, i.response.bordersByRootIdAndLevel, i.nodes, OrgChart.action.update, !0), P = 0; P < z.length; P++) {
                                var Y;
                                j = z[P];
                                (Y = i.element.querySelector(`[data-l-id="[${j.id}][${j.childId}]"]`)) && (Y.innerHTML = j.html)
                            }
                    if (!t._dragEventFired && (Math.abs(r.x - I.x) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE || Math.abs(r.y - I.y) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE)) {
                        if (!1 === OrgChart.events.publish("drag", [i, a, e, n]) && E(), i.config.enableDragDrop)
                            for (_ = 0; _ < f.length; _++) h.insertBefore(f[_], h.firstChild);
                        t._dragEventFired = !0
                    }
                    for (_ = 0; _ < g.length; _++) f[_].setAttribute("transform", "matrix(" + g[_].toString() + ")"), m[_] && m[_].setAttribute("transform", "matrix(" + C[_].toString() + ")")
                }
            }
        },
        E = function(e) {
            for (var a = 0; a < c.length; a++) c[a].x = p[a].x, c[a].y = p[a].y;
            if (i.moveEnd(), h.classList && (h.classList.remove("boc-cursor-grab"), h.classList.remove("boc-cursor-move"), h.classList.remove("boc-cursor-nodrop"), h.classList.remove("boc-cursor-copy")), h.removeEventListener(r.move, N), h.removeEventListener(r.up, E), r.leave && h.removeEventListener(r.leave, E), c[0].id != k && null != k) {
                var n = i.getNode(k);
                if (!1 === (o = OrgChart.events.publish("drop", [i, c[0].id, n.id, f[0], e]))) return L(k, S), void(i._gragStartedId = null);
                if (i.canUpdateLink(c[0].id, k))(C = i.get(c[0].id)).pid = k, C.stpid = null, i.updateNode(C, null, !0);
                else L(k, S);
                i._gragStartedId = null
            } else {
                if (t._dragEventFired) {
                    var o = OrgChart.events.publish("drop", [i, c[0].id, void 0, f[0], e]);
                    if (i.config.movable && !1 !== o)
                        if (i.config.movable == OrgChart.movable.detachTree) {
                            var d = OrgChart._getTransform(i.getNodeElement(s.id));
                            (C = i.get(s.id)).pid = null, C.stpid = null, i.updateNode(C, null, !0)
                        } else {
                            var g = [];
                            i.config.movable == OrgChart.movable.node ? g.push(s.id) : l(s, g);
                            var u = (d = OrgChart._getTransform(i.getNodeElement(s.id)))[4] - s.x,
                                m = d[5] - s.y;
                            for (a = 0; a < g.length; a++) {
                                var C;
                                (C = i.get(g[a])) && (null != C.movex ? C.movex += u : C.movex = u, null != C.movey ? C.movey += m : C.movey = m, i.update(C))
                            }
                            OrgChart.events.publish("updated", [i]), i.draw(OrgChart.action.update, {
                                dragNodeIdList: g
                            })
                        }
                }
    ...
    h.addEventListener(r.move, N), h.addEventListener(r.up, E), r.leave && h.addEventListener(r.leave, E)
            ...
            if (d) {
                ...
                if (C.left || C.right || C.up || C.down) {
                    ...
                    s.moveStart(C, (function(t) {
                        c[4] = b + t.x, c[5] = v + t.y, d.x = y - t.xWithoutScale, d.y = x - t.yWithoutScale, r.x = _ - t.xWithoutScale, r.y = w - t.yWithoutScale, f.setAttribute("transform", "matrix(" + c.toString() + ")")
                    }))
                } else {
                    if (s.moveEnd(), h.classList && (h.classList.add("boc-cursor-grab"), h.classList.remove("boc-cursor-move"), h.classList.remove("boc-cursor-nodrop"), h.classList.remove("boc-cursor-copy")), m(o, l), o = null, l = null, s.config.enableDragDrop)
                        for (; null != i && i != h;) {
                            if (i.hasAttribute && i.hasAttribute(OrgChart.attr.node_id)) {
                    ...
                    var N = (r.x - d.x) / u,
                        E = (r.y - d.y) / u;
                    if (c[4] = g + N, c[5] = p + E, !t._dragEventFired && (Math.abs(r.x - d.x) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE || Math.abs(r.y - d.y) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE)) !1 === OrgChart.events.publish("drag", [s, k, e]) && O(), t._dragEventFired = !0;
                    f.setAttribute("transform", "matrix(" + c.toString() + ")")
                }
            }
        },
        O = function(e) {
            if (s.moveEnd(), h.classList && (h.classList.remove("boc-cursor-grab"), h.classList.remove("boc-cursor-move"), h.classList.remove("boc-cursor-nodrop"), h.classList.remove("boc-cursor-copy")), h.removeEventListener(r.move, C), h.removeEventListener(r.up, O), r.leave && h.removeEventListener(r.leave, O), n.id == o || null == o) return t._dragEventFired && OrgChart.events.publish("drop", [s, n.id, void 0, f, e]), h.removeChild(f), void(s._gragStartedId = null);
            var i = s.getNode(o);
            ...
            if (s.canUpdateLink(n.id, o)) {
                var a = s.get(n.id);
                a.pid = o, a.stpid = null, null != a.movex && (a.movex = void 0), null != a.movey && (a.movey = void 0), s.updateNode(a, null, !0)
    ...
    if (t) {
        if (!this._moveInterval) {
            var a = this,
                ...
                s = 0,
                h = 1;
            OrgChart.isNEU(r) && (r = OrgChart.anim.inSin), OrgChart.isNEU(i) && (i = 3e3), this._moveInterval = setInterval((function() {
                var d = {
                    x: 0,
                    y: 0,
                    xWithoutScale: 0,
                ...
                t.left ? (l++, d.x = l * OrgChart.MOVE_STEP / o, d.xWithoutScale = l * OrgChart.MOVE_STEP) : t.right && (l++, d.x = -l * OrgChart.MOVE_STEP / o, d.xWithoutScale = -l * OrgChart.MOVE_STEP), t.up ? (s++, d.y = s * OrgChart.MOVE_STEP / o, d.yWithoutScale = s * OrgChart.MOVE_STEP) : t.down && (s++, d.y = -s * OrgChart.MOVE_STEP / o, d.yWithoutScale = -s * OrgChart.MOVE_STEP);
                var c = r((10 * h - 10) / i);
    ...
    var h = function(t) {
        ...
        d = function() {
            "pan" == s.type && i.config.sticky ? setTimeout((function() {
                ...
                i._draw(!0, OrgChart.action.pan)
            }), 0), "pan" == s.type && i._changeCursorOnPanEnd(), s = null, t.removeEventListener(r.move, h), t.removeEventListener(r.up, d), r.leave && t.removeEventListener(r.leave, d), r.touchstart && t.removeEventListener(r.touchstart, d)
        };
    ...
    this.instance.element.insertBefore(l, h), OrgChart.input.init(l), this.input = document.getElementById(s.id), this.xBtn.addEventListener("click", (function(t) {
        ...
        "ArrowDown" == t.key ? d() : "ArrowUp" == t.key ? c() : "Enter" == t.key ? e._enterHandler() : "Escape" == t.key ? e.hide() : this.value.length >= OrgChart.MINIMUM_SYMBOLS_IN_SEARCH_INPUT && e._search()
    }));
    var d = function() {
        ...
        if (t.hasAttribute("data-search-item-id")) {
            ...
            if (this.input.value != OrgChart.SEARCH_HELP_SYMBOL) {
                var r = OrgChart.events.publish("", [this.instance, e]),
                    i = OrgChart.events.publish("searchclick", [this, {
                        nodeId: e
                    }]);
    ...
    if (null == this.instance.config.searchFields) {
        ...
        for (var t = 0; t < this.instance.response.allFields.length; t++) {
            ...
            "tags" == e || OrgChart._fieldIsImg(this.instance.config, e) || -1 == this._searchFields.indexOf(e) && this._searchFields.push(e)
        }
    ...
    this.lastSearch = OrgChart._search.search(this.instance.config.nodes, this.input.value, this._searchFields, this._searchFields, this.instance.config.searchDisplayField, this.instance.config.searchFieldsWeight, this.searchFieldsAbbreviation)
        ...
        if (this.hasAttribute("data-search-item-id")) {
            ...
            if (e.input.value != OrgChart.SEARCH_HELP_SYMBOL) {
                var r = OrgChart.events.publish("searchclick", [e.instance, t]),
                    i = OrgChart.events.publish("searchclick", [e, {
                        nodeId: t
                    }]);
                if (!1 === r && (i = !1), !1 !== i) {
    ...
    for (var e in this.searchFieldsAbbreviation) t += `<tr data-search-item-id="${e}" style="height: 50px;"><td class="boc-search-image-td" style="text-align: center;">${e}</td><td class="boc-search-text-td">${this.searchFieldsAbbreviation[e]}</td></tr>`;
    return t += "</table>"
    ...
    null == o && (o = OrgChart.local), o._setPositions(n, r.layoutConfigs, (function(e) {
        ...
        for (var l = {
                ...
                maxX: null,
                maxY: null
            }, s = {}, h = [], d = 0; d < n.length; d++) OrgChart.manager._setMinMaxXYAdjustifyIterate(n[d], n[d], l, 0, s, o, r.config.orientation, h);
        for (var c in h)
            for (var g in h[c]) {
                var p = s[c][g],
                    u = h[c][g];
                null == p.minX && null == p.minY && null == p.maxX && null == p.maxY && OrgChart._setMinMaxXY(u, p)
            }
        t({
            minX: l.minX,
            minY: l.minY,
    ...
    if (h != OrgChart.action.minimize || t.min ? h == OrgChart.action.maximize && !0 === t.min ? (d.all || d.id == t.id) && (t.min = !1) : h == OrgChart.action.exporting && !1 === d.min ? t.min = !1 : h == OrgChart.action.init && null != c && (t.min = c.min.has(t.id)) : (d.all || d.id == t.id) && (t.min = !0), !t.min)
    ...
    if (OrgChart.manager._initNode(e, r, s, i, h, d, c), e.isAssistant && (n[e.pid] || (n[e.pid] = []), n[e.pid].push(e.id)), e.subLevels > 0 && o.push(e.id), OrgChart.MIXED_LAYOUT_FOR_NODES_WITH_COLLAPSED_CHILDREN && !e.isAssistant && e.parent) {
        ...
        }(OrgChart.MIXED_LAYOUT_ALL_NODES && p.length > OrgChart.MIXED_LAYOUT_IF_NUMBER_OF_CHILDREN_IS_MORE_THEN && p.length == e.parent.childrenIds.length - u - f || !OrgChart.MIXED_LAYOUT_ALL_NODES && p.length > OrgChart.MIXED_LAYOUT_IF_NUMBER_OF_CHILDREN_IS_MORE_THEN) && (l[e.pid] = p)
    }
    ...
    for (var O = 0; O < e.stChildren.length; O++) {
        ...
        for (m = 0; m < e.tags.length; m++)
            if (g[e.tags[m]]) {
                b = e.tags[m];
                break
            } a.push(e.stChildren[O].id), OrgChart.manager._iterate(t, e.stChildren[O], r, 0, a, n, o, l, b, h, d, c)
    }
    i++;
    for (O = 0; O < e.children.length; O++) OrgChart.manager._iterate(t, e.children[O], r, i, a, n, o, l, s, h, d, c)
    ...
    for (var s = [], h = OrgChart._addDottedLines(r), d = 0; d < h.length; d++) {
        ...
        OrgChart.isNEU(g.ppid) || (f.ppid = g.ppid), OrgChart.isNEU(g.stpid) || (f.stpid = g.stpid), null != r.orderBy && (f.order = OrgChart.manager._getOrderFieldValue(g, r.orderBy)), null != g.movex && (f.movex = g.movex), null != g.movey && (f.movey = g.movey), t[g.id] = f, s.push(g.id)
    }
    ...
    for (d = 0; d < s.length; d++) {
        ...
        } else b ? (C && (f.collapsed = C.collapsed, f.min = C.min), b.childrenIds.push(f.id)) : (C && (f.collapsed = C.collapsed, f.min = C.min), e.push(f), o.push(f.id));
    ...
    if (OrgChart.manager.__createNodes(l, s, e, i, a, n, h, t), null != e.roots) {
        ...
        for (var d = 0; d < e.roots.length; d++) {
            ...
            if (c && i == OrgChart.action.centerNode) {
                ...
                for (var p = l[a.id];
                    (null != p.pid || null != p.stpid) && p != c;) p = null == p.pid && null != p.stpid ? l[p.stpid] : l[p.pid];
                g == p && (c = g)
            }
            if (c) {
                for (var u = !1, f = 0; f < s.length; f++)
                    ...
                    if (!OrgChart.isNEU(c.pid))(ft = (O = l[c.pid]).childrenIds.indexOf(c.id)) > -1 && O.childrenIds.splice(ft, 1);
                    s.push(c)
                }
            }
        }
    ...
    if (i == OrgChart.action.init && e.expand && e.expand.nodes && null == o)
        for (d = 0; d < e.expand.nodes.length; d++) {
            ...
            for (d = 0; d < it.length; d++)
                for (var O = l[(C = l[it[d]]).pid]; O;) m.push(O.id), null == O.pid && null != O.stpid ? (O = l[O.stpid]).min = !1 : O = l[O.pid]
        } else if (i == OrgChart.action.centerNode) {
        for (var b = l[a.id]; b;) {
            if (m.push(b.id), a.options.parentState === OrgChart.COLLAPSE_PARENT_NEIGHBORS && b)
    ...
    for (d = 0; d < S.length; d++) {
        ...
        for (v = L.length - 1; v >= 0; v--)
            if (N[L[v]])
                for (f = 0; f < N[L[v]].length; f++) C.children.push(l[N[L[v]][f]]), M++, -1 == U.indexOf(L[v]) && U.push(L[v]);
        ...
        for (v = 0; v < A.length; v++)
            if (N[A[v]])
                for (f = 0; f < N[A[v]].length; f++) C.children.push(l[N[A[v]][f]]), T++, -1 == B.indexOf(A[v]) && B.push(A[v]);
        for (v = 0; v < R.length; v++) {
            (H = l[R[v]]).collapsed || (H.parentPartner = H.parent, H.parent = C, H.isChildOfPartner = !0, C.children.push(H))
        }
        C.partnerSeparation = Math.max(U.length, B.length) * e.partnerChildrenSplitSeparation + e.minPartnerSeparation, I.length || !M || T ? I.length || M || !T ? I.length || 1 != M || 1 != T ? I.length || M || T ? !I.length || M || T ? I.length && (M || T) ? C.hasPartners = 7 : C.hasPartners = 1 : C.hasPartners = 6 : C.hasPartners = 5 : C.hasPartners = 4 : C.hasPartners = 3 : C.hasPartners = 2
    }
    for (d = 0; d < w.length; d++) {
        var D = r[(C = l[w[d]]).lcn ? C.lcn : "base"];
        for (v = 0; v < C.subLevels; v++) {
            var z = new OrgChart.node(C.id + "_sub_level_index_" + v, C.pid, [], "subLevel");
            if (OrgChart.manager._initDinamicNode(z, C.lcn), O = C.parent)(ft = O.children.indexOf(C)) > -1 && (O.children.splice(ft, 1), O.children.splice(ft, 0, z)), z.children.push(C), z.parent = O, C.parent = z, l[z.id] = z
        }
    }
    for (var j in _) {
        (O = l[j]).hasAssistants = !0;
        z = new OrgChart.node(O.id + "_split_assitant_0", O.id, ["assistant"], "split");
        OrgChart.manager._initDinamicNode(z, O.lcn, !0), l[z.id] = z;
        var Y = [];
        for (v = O.children.length - 1; v >= 0; v--) {
            (H = O.children[v]).isAssistant ? (H.parent = null, O.children.splice(v, 1), Y.splice(0, 0, H.id)) : H.isPartner || (H.parent && k[H.parent.id] && z && H.parent.id != z.id && (Object.defineProperty(k, z.id, Object.getOwnPropertyDescriptor(k, H.parent.id)), delete k[H.parent.id]), H.parent = z, z.children.unshift(H), O.children.splice(v, 1))
        }
        if (Y.length % 2) {
            var X = l[Y[Y.length - 1]],
                q = new OrgChart.node(X.id + "_mirror", O.pid, [], "mirror");
            OrgChart.manager._initDinamicNode(q, X.lcn, !0), q.isAssistant = !0, q.w = X.w, q.h = X.h, l[q.id] = q, Y.splice(Y.length - 1, 0, q.id)
        }
        var $ = 1;
        for (v = Y.length - 1; v >= 0; v--)
            if (v % 2 && v != Y.length - 1) {
                var V = new OrgChart.node(O.id + "_split_assitant_" + $, O.pid, [], "split");
                OrgChart.manager._initDinamicNode(V, O.lcn, !0), l[V.id] = V, Y.splice(v, 0, V.id), $++
    ...
    if (Z || tt) {
        ...
        if (w.length) {
            ...
            if (rt) {
                ...
                for (var j in k) {
                    ...
                    for (d = 0; d < it.length; d++) {
                        var ht = it[d];
                        (null === st || w.has(ht)) && (st = l[ht].parent.id, lt || OrgChart.isNEU(l[ht].subLevels) || (lt = l[ht].subLevels > 0)), at[st] || (at[st] = []), at[st].push(ht), lt && (ot[st] = j, nt[st] || (nt[st] = []), nt[st].push(ht))
                    }
                }
                for (var j in k = {}, nt)
        ...
        for (var j in k) {
            ...
            if (0 != (D = r[O.lcn ? O.lcn : "base"]).layout || tt) {
                et.pnode = O, et.layout = D.layout, et.layoutGridColumns = e.layoutGridColumns, et.childrenIds = k[j], et.lastChildrenPidIds = k, et.subLevels = 0, et.layouts = [], OrgChart.events.publish("node-layout", [t, et]), OrgChart.events.publish("layout", [et]), et.layouts.length || et.layouts.push({
                    layout: et.layout,
                ...
                for (var gt = 0; gt < et.layouts.length; gt++) {
                    ...
                    for (OrgChart.isNEU(pt.subLevels) && (pt.subLevels = 0), OrgChart.isNEU(pt.layout) && (pt.layout = D.layout), ct = O = l[j]; ct.isSplit;) ct = l[ct.pid];
                    for (; ct.isSubLevel;) ct = l[ct.pid];
                    var ut = O;
                    ...
                    if (pt.subLevels) {
                        for (v = 0; v < pt.childrenIds.length; v++) {
                            var ft;
                            H = l[pt.childrenIds[v]]; - 1 != (ft = O.children.indexOf(H)) && O.children.splice(ft, 1), H.parent = ut, ut.children.push(H)
                        }
                        O = ut
                    }
                    if (pt.layout == OrgChart.layout.grid && pt.childrenIds.length > 2) {
                        "dynamic" == pt.layoutGridColumns && (pt.layoutGridColumns = OrgChart._getDynamicGridCoulumns(pt.childrenIds.length));
                        var mt = O.id;
                        ...
                        for (d = 0; d < pt.childrenIds.length; d += Ct) {
                            ...
                            for (v = 0; v < Ct; v++) {
                                ...
                                (H = l[ht = pt.childrenIds[d + v]]).parent = l[mt], l[mt].children.push(H), bt || (Ct / 2 - 1 == v && (Ot = new OrgChart.node(pt.childrenIds[d + v - 1] + "_grid_pseudo_node_" + pt.childrenIds[d + v + 1], mt, [], "subLevel"), OrgChart.manager._initDinamicNode(Ot, O.lcn), Ot.parent = l[mt], l[mt].children.push(Ot), l[Ot.id] = Ot), Ct - 1 == v && (mt = Ot.id))
                            }
                        }
                    }
                    if (pt.layout == OrgChart.layout.mixed) {
                        ...
                        for (d = vt.length - 1; d >= 0; d--) {
                            ...
                            for (v = O.children.length - 1; v >= 0; v--)
                                ...
                                var yt = l[vt[d - 1]];
                                H.parent = yt, H.layout = OrgChart.layout.mixed, yt.children.push(H)
                            } else O.children.push(H)
                        }
                    } else if (pt.layout > 1) {
                        z = new OrgChart.node(gt + "_" + O.id + "_split_0", ct.id, [], "split");
                        OrgChart.manager._initDinamicNode(z, O.lcn), l[z.id] = z, z.layout = pt.layout;
                        var xt = [];
                        for (d = pt.childrenIds.length - 1; d >= 0; d--) {
                            for (H = l[pt.childrenIds[d]], v = 0; v < O.children.length; v++) O.children[v].id == H.id && O.children.splice(v, 1);
                            if (H.parent = null, H.layout = pt.layout, pt.layout != OrgChart.layout.treeRightOffset && pt.layout != OrgChart.layout.treeRight || xt.splice(0, 0, H.id), pt.layout > 2) {
                                var _t = new OrgChart.node(gt + "_" + H.id + "_mirror", ct.id, [], "mirror");
                                OrgChart.manager._initDinamicNode(_t, H.lcn), _t.layout = pt.layout, l[_t.id] = _t, xt.splice(0, 0, _t.id)
                            }
                            pt.layout != OrgChart.layout.treeRightOffset && pt.layout != OrgChart.layout.treeRight && xt.splice(0, 0, H.id)
                        }
                        for ($ = 1, v = xt.length - 1; v >= 0; v--)
                            if (v % 2 && v != xt.length - 1) {
                                V = new OrgChart.node(gt + "_" + O.id + "_split_" + $, ct.id, [], "split");
                                OrgChart.manager._initDinamicNode(V, O.lcn), V.layout = pt.layout, l[V.id] = V, xt.splice(v, 0, V.id), $++
                            } else v % 2 && xt.splice(v, 0, z.id);
                        for (v = 0; v < xt.length; v += 3) {
                            G = null;
                            0 == v && (G = O);
                            W = l[xt[v]], J = l[xt[v + 1]], K = l[xt[v + 2]];
                            0 != v && (G = l[xt[v - 3]]), 0 == v || J || (G = l[xt[v - 2]]), W.parent = G, G.children.push(W), J && (0 != v && (G = l[xt[v - 2]]), J.parent = G, G.children.push(J)), K && (0 != v && (G = l[xt[v - 1]]), K.parent = G, G.children.push(K))
                        }
                    }
                }
            }
    ...
    if (OrgChart.VERTICAL_CHILDREN_ASSISTANT)
        for (d = 0; d < s.length; d++) OrgChart.manager._verticalAssistantIterate(s[d], l);
    et = {
        nodes: l,
        roots: s
    };
    return OrgChart.events.publish("nodes-initialized", [t, et]), {
        nodes: et.nodes,
        roots: et.roots,
        rootList: h
    }
    ...
    var f = h[0],
        ...
        b = a - o + 2 * i.padding,
        v = n - l + 2 * i.padding,
        y = OrgChart.getScale(s, t, e, i.scaleInitial, i.scaleMax, i.scaleMin, b, v);
    ...
    if (d == OrgChart.action.insert || d == OrgChart.action.expand || d == OrgChart.action.collapse || d == OrgChart.action.update || d == OrgChart.action.centerNode) {
        var I = null;
        ...
        else if (d != OrgChart.action.expand && d != OrgChart.action.collapse || !c || null == c.id || null == c.id) {
    ...
    if (OrgChart.manager._isVisible(t, r, i, a)) {
        ...
        if (null != d && null != d.x && null != d.y)
            if (d.x != t.x || d.y != t.y) n && n.dragNodeIdList && -1 != n.dragNodeIdList.indexOf(t.id) || (h[0].push(t.id), h[1].push({
...
}, OrgChart.manager._setMinMaxXYAdjustifyIterate = function(t, e, r, i, a, n, o, l) {
    t.x += n.x, t.y += n.y;
    for (var s = 0; s < t.stChildren.length; s++) OrgChart.manager._setMinMaxXYAdjustifyIterate(t.stChildren[s], t.stChildren[s], r, 0, a, n, o, l);
    t.isPartner ? t.sl = i - 1 : t.sl = i, null == a[e.id] && (a[e.id] = {}), null == a[e.id][t.sl] && (a[e.id][t.sl] = {
        minX: null,
        minY: null,
        maxX: null,
        maxY: null
    }), t.layout ? (null == l[e.id] && (l[e.id] = {}), null == l[e.id][t.sl] && (l[e.id][t.sl] = t)) : OrgChart._setMinMaxXY(t, a[e.id][t.sl]), null != t.movex && (t.x += t.movex), null != t.movey && (t.y += t.movey), OrgChart._setMinMaxXY(t, r), i++;
    for (s = 0; s < t.children.length; s++) OrgChart.manager._setMinMaxXYAdjustifyIterate(t.children[s], e, r, i, a, n, o, l)
        ...
        for (var r = [], i = 0; i < t.groupDottedLines.length; i++) {
            ...
            if (!r.has(n))
                for (var o = 0; o < e.length; o++)
                    if (e[o].id == a.rootId) {
                        (d = JSON.parse(JSON.stringify(e[o]))).id = `balkan_group_dotted_${a.rootId}_balkan_id_${e[o].id}`, d.pid = void 0, d.stpid = e[o].id, e.push(d), r.push(n), e[o].tags || (e[o].tags = []), e[o].tags.push("group-dotted-lines"), e[o].tags.push("group-dotted-lines-" + n);
                        break
                ...
                if (e[o].id == a.from) {
                    if ((d = JSON.parse(JSON.stringify(e[o]))).id = `balkan_group_dotted_${a.rootId}_balkan_id_${e[o].id}`, d.pid = `balkan_group_dotted_${a.rootId}_balkan_id_${a.to}`, d.tags) {
                        var l = d.tags.indexOf("group-dotted-lines"); - 1 != l && d.tags.splice(l, 1)
                    }
                    if (d.tags || (d.tags = []), d.tags.push("boc-dotted-connector"), a.tags)
    ...
    if (t.dottedLines.length)
        for (i = 0; i < t.dottedLines.length; i++) {
            ...
            for (o = 0; o < e.length; o++)
                if (e[o].id == h.from) {
                    var d;
                    if ((d = JSON.parse(JSON.stringify(e[o]))).id = `balkan_dotted_${h.rootId}_balkan_id_${e[o].id}`, h.rootId == h.to ? d.pid = h.to : d.pid = `balkan_dotted_${h.rootId}_balkan_id_${h.to}`, d.tags || (d.tags = []), d.tags.push("boc-dotted-connector"), h.tags)
    ...
    node: function(t, e, r, i, a, n, o, l, s, h) {
        ...
        for (var p in o) {
            ...
            if (g.value = u, g.element = d[p], g.name = f, g.field = p, !1 !== OrgChart.events.publish("field", [h, g]) && null != g.value && null != g.value && null != g.element && (!m || m && !OrgChart.isNEU(g.value))) {
                ...
                c += O = O.replaceAll("{ew}", t.w - (t.padding ? t.padding[1] : 0)).replaceAll("{cw}", t.w / 2).replaceAll("{randId}", OrgChart.randomId()).replaceAll("{randId2}", OrgChart.randomId())
            }
        }
        ...
        var y = "";
        t.lcn && (y = 'lcn="' + t.lcn + '"');
        var x = OrgChart.nodeOpenTag.replace("{lcn}", y).replace("{id}", t.id).replace("{class}", v).replace("{sl}", t.sl).replace("{level}", t.level).replace("{x}", b.x).replace("{y}", b.y),
    ...
    link: function(t, e, r, i, a, n, o) {
        ...
        if (t.hasPartners) {
            ...
            for (var C = 0; C < t.children.length; C++) {
                (b = t.children[C]).parentPartner ? (m.ppnodes[b.id] = b.parentPartner, m.ids.push(b.id), 1 == b.parentPartner.isPartner ? (-1 == m.rightIds.indexOf(b.parentPartner.id) && m.rightIds.push(b.parentPartner.id), m.indexes[b.id] = m.rightIds.indexOf(b.parentPartner.id), m.firstRight || (m.firstRight = b)) : 2 == b.parentPartner.isPartner && (-1 == m.leftIds.indexOf(b.parentPartner.id) && m.leftIds.push(b.parentPartner.id), m.indexes[b.id] = m.leftIds.indexOf(b.parentPartner.id), m.lastLeft = b)) : b.isPartner || (m.lastLeft = b, m.firstRight || (m.firstRight = b))
            }
            m.maxSidePartnersWithChildren = Math.max(m.leftIds.length, m.rightIds.length), p = 0 == m.maxSidePartnersWithChildren ? e.config.minPartnerSeparation / 2 : e.config.minPartnerSeparation / 2 + m.partnerChildrenSplitSeparation * m.maxSidePartnersWithChildren + m.partnerChildrenSplitSeparation / 2
        }
        for (C = 0; C < t.children.length; C++) {
            var O, b = t.children[C],
                v = i[u][b.sl],
                y = {
                    xa: 0,
                    ya: 0,
            ...
            if (b.isChildOfPartner) switch (s.orientation) {
                case OrgChart.orientation.top:
                case OrgChart.orientation.top_left:
            ...
            } else if (m && -1 != m.ids.indexOf(b.id)) switch (s.orientation) {
                case OrgChart.orientation.top:
                case OrgChart.orientation.top_left:
                ...
                var w = b.isAssistant && b.rightNeighbor && b.rightNeighbor.isAssistant && b.parent == b.rightNeighbor.parent,
                    k = b.isAssistant && b.leftNeighbor && b.leftNeighbor.isAssistant && b.parent == b.leftNeighbor.parent;
                if ((w || b.layout > 1) && b.rightNeighbor && b.rightNeighbor.isSplit) switch (s.orientation) {
                    case OrgChart.orientation.top:
                    case OrgChart.orientation.top_left:
                    case OrgChart.orientation.bottom:
                    case OrgChart.orientation.bottom_left:
                ...
                } else if ((k || b.layout > 1) && b.leftNeighbor && b.leftNeighbor.isSplit) switch (s.orientation) {
                    case OrgChart.orientation.top:
                    case OrgChart.orientation.top_left:
                    case OrgChart.orientation.bottom:
                    case OrgChart.orientation.bottom_left:
                    ...
                    case OrgChart.orientation.top:
                    case OrgChart.orientation.top_left:
                        if (1 == b.isPartner) y = OrgChart.ui._linkLeftToRight(t, b, h, p);
                        else if (2 == b.isPartner) y = OrgChart.ui._linkRightToLeft(t, b, h, p);
                        else {
                    ...
                    case OrgChart.orientation.right:
                    case OrgChart.orientation.right_top:
                        if (1 == b.isPartner) y = OrgChart.ui._linkTopToBottom(t, b, h, p);
                        else if (2 == b.isPartner) y = OrgChart.ui._linkBottomToTop(t, b, h, p);
                        else {
                            _ = 1 == b.layout ? void 0 : v.maxX - (v.maxX - f.minX) / 2;
            ...
            if (S) O = S, x = x.replaceAll("{rounded}", S).replaceAll("{edge}", S).replaceAll("{curve}", O);
            else if (-1 != x.indexOf("{rounded}"))
                if (y.xa == y.xb && y.xa == y.xc && y.xa == y.xd || y.ya == y.yb && y.ya == y.yc && y.ya == y.yd) O = "M" + y.xa + "," + y.ya + " L" + y.xd + "," + y.yd, x = x.replaceAll("{rounded}", O);
                else if (Math.abs(y.xa - y.xd) <= OrgChart.LINK_ROUNDED_CORNERS && Math.abs(y.xa - y.xc) <= OrgChart.LINK_ROUNDED_CORNERS && Math.abs(y.xa - y.xb) <= OrgChart.LINK_ROUNDED_CORNERS) O = "M" + y.xa + "," + y.ya + " L" + y.xa + "," + y.yd, x = x.replaceAll("{rounded}", O);
            else if (Math.abs(y.ya - y.yd) <= OrgChart.LINK_ROUNDED_CORNERS && Math.abs(y.ya - y.yc) <= OrgChart.LINK_ROUNDED_CORNERS && Math.abs(y.ya - y.yb) <= OrgChart.LINK_ROUNDED_CORNERS) O = "M" + y.xa + "," + y.ya + " L" + y.xd + "," + y.ya, x = x.replaceAll("{rounded}", O);
            else {
                var I = OrgChart.ui._roundedEdge(y.xa, y.ya, y.xb, y.yb, y.xc, y.yc),
                    A = OrgChart.ui._roundedEdge(y.xb, y.yb, y.xc, y.yc, y.xd, y.yd);
                O = "M" + I.x1 + "," + I.y1 + " " + I.x2 + "," + I.y2 + " Q" + I.qx1 + "," + I.qy1 + " " + I.qx2 + "," + I.qy2 + " L" + A.x2 + "," + A.y2 + " Q" + A.qx1 + "," + A.qy1 + " " + A.qx2 + "," + A.qy2 + " L" + A.x3 + "," + A.y3, x = x.replaceAll("{rounded}", O)
            } else - 1 != x.indexOf("{edge}") ? (O = "M" + y.xa + "," + y.ya + " " + y.xb + "," + y.yb + " " + y.xc + "," + y.yc + " L" + y.xd + "," + y.yd, x = x.replaceAll("{edge}", O)) : -1 != x.indexOf("{curve}") ? (O = "M" + y.xa + "," + y.ya + " C" + y.xb + "," + y.yb + " " + y.xc + "," + y.yc + " " + y.xd + "," + y.yd, x = x.replaceAll("{curve}", O)) : (O = x.replaceAll("{xa}", y.xa).replaceAll("{ya}", y.ya).replaceAll("{xb}", y.xb).replaceAll("{yb}", y.yb).replaceAll("{xc}", y.xc).replaceAll("{yc}", y.yc).replaceAll("{xd}", y.xd).replaceAll("{yd}", y.yd), x = O);
            d.push(OrgChart.linkOpenTag.replaceAll("{id}", t.id).replaceAll("{class}", "link " + b.tags.join(" ")).replaceAll("{child-id}", b.id));
            var L = {
                node: t,
                cnode: b,
                p: y,
            ...
            OrgChart.events.publish("render-link", [e, L]), d.push(L.html), o && c.push({
                id: t.id,
                childId: b.id,
                html: L.html
            });
            ...
            for (var E in e.config.linkBinding) {
                ...
                if (T) {
                    var B = T[M];
                    L.value = B, L.element = h[E], L.name = M, !1 !== OrgChart.events.publish("label", [e, L]) && (OrgChart.isNEU(L.value) || OrgChart.isNEU(L.element) || (N += L.element.replace("{val}", L.value)))
                }
            }
            if ("" != N) {
                var U = y.x,
                    R = y.y;
                null != b.movey && (R += b.movey), N = OrgChart.linkFieldsOpenTag.replace("{x}", U).replace("{y}", R).replace("{rotate}", 0) + N + OrgChart.grCloseTag, d.push(N)
            }
    ...
    _roundedEdge: function(t, e, r, i, a, n) {
        var o, l, s, h = OrgChart.LINK_ROUNDED_CORNERS,
            d = 0;
        return t == r && t == a || e == i && e == n ? (o = s = r, l = d = i) : (t != a && r == a && (o = s = r, l = i, e < n ? d = i + h : e > n && (d = i - h)), t < a && r == a ? r -= h : t > a && r == a && (r += h), e != n && i == n && (o = r, l = d = i, t < a ? s = r + h : t > a && (s = r - h)), e < n && i == n ? i -= h : e > n && i == n && (i += h)), {
            x1: t,
            y1: e,
            x2: r,
            y2: i,
    ...
    _linkTopToBottom: function(t, e, r, i, a) {
        ...
        return n = t.x + t.w / 2 + r.linkAdjuster.toX, o = t.y + t.h + r.linkAdjuster.toY, s = l = e.x + e.w / 2 + r.linkAdjuster.fromX, h = e.y + r.linkAdjuster.fromY, {
            ...
            ya: o,
            xb: n,
            yb: d = t.rightNeighbor && t.rightNeighbor.isAssistant && "split" == e.templateName ? t.rightNeighbor.y + t.rightNeighbor.h + i : "split" == t.templateName && (e.isAssistant || e.layout > 1) ? h : "split" == e.templateName ? o + i : null != a ? a : h - i,
            xc: l,
            yc: d,
            xd: s,
            yd: h,
    ...
    _linkBottomToTop: function(t, e, r, i, a) {
        ...
        return n = t.x + t.w / 2 + r.linkAdjuster.toX, o = t.y + r.linkAdjuster.toY, s = l = e.x + e.w / 2 + r.linkAdjuster.fromX, h = e.y + e.h + r.linkAdjuster.fromY, {
            ...
            ya: o,
            xb: n,
            yb: d = t.rightNeighbor && t.rightNeighbor.isAssistant && "split" == e.templateName ? t.rightNeighbor.y - i : "split" == t.templateName && (e.isAssistant || e.layout > 1) ? h : "split" == e.templateName ? o - i : null != a ? a : h + i,
            xc: l,
            yc: d,
            xd: s,
            yd: h,
    ...
    _linkRightToLeft: function(t, e, r, i, a) {
        ...
        return n = t.x + r.linkAdjuster.toX, o = t.y + t.h / 2 + r.linkAdjuster.toY, h = e.x + e.w + r.linkAdjuster.fromX, d = s = e.y + e.h / 2 + r.linkAdjuster.fromY, l = o, 90, {
            xa: n,
            ya: o,
            xb: c = t.rightNeighbor && t.rightNeighbor.isAssistant && "split" == e.templateName ? t.rightNeighbor.x - i : "split" == t.templateName && (e.isAssistant || e.layout > 1) ? h : "split" == e.templateName ? n - i : null != a ? a : h + i,
            yb: l,
            xc: c,
            yc: s,
            xd: h,
    ...
    _linkLeftToRight: function(t, e, r, i, a) {
        ...
        return n = t.x + t.w + r.linkAdjuster.toX, o = t.y + t.h / 2 + r.linkAdjuster.toY, h = e.x + r.linkAdjuster.fromX, d = s = e.y + e.h / 2 + r.linkAdjuster.fromY, l = o, 270, {
            xa: n,
            ya: o,
            xb: c = t.rightNeighbor && t.rightNeighbor.isAssistant && "split" == e.templateName ? t.rightNeighbor.x + t.rightNeighbor.w + i : "split" == t.templateName && (e.isAssistant || e.layout > 1) ? h : "split" == e.templateName ? n + i : null != a ? a : h - i,
            yb: l,
            xc: c,
            yc: s,
            xd: h,
    ...
    if (-1 != c.indexOf("multiline")) {
        ...
        b.setAttributeNS(null, "x", l), b.setAttributeNS(null, "y", s), b.setAttributeNS(null, "text-anchor", h), b.appendChild(v), p.appendChild(b);
        m = 1;
        for (var y = 1, x = !1, _ = 1; _ < C.length; _++) {
            var w = b.firstChild.data.length;
            if (b.firstChild.data += " " + C[_], b.getComputedTextLength() > d) {
                if (b.firstChild.data = b.firstChild.data.slice(0, w), y++, a && y > a) {
                    if (n && p.children.length == a) {
                        var k = p.children[a - 1].textContent;
                        p.children[a - 1].textContent = k.substring(0, k.length - 3) + "...", x = !0
                    }
                    break
                }(b = document.createElementNS(g, "tspan")).setAttributeNS(null, "x", l), b.setAttributeNS(null, "y", s + O * m), b.setAttributeNS(null, "text-anchor", h), v = document.createTextNode(C[_]), b.appendChild(v), p.appendChild(b), m++
            }
        }
        var S = "";
        if (null != p.innerHTML) S = p.innerHTML, p.innerHTML = "";
            ...
            var I = "";
            for (_ = p.childNodes.length - 1; _ >= 0; _--) I = XMLSerializer().serializeToString(p.childNodes[_]) + I, p.removeChild(p.childNodes[_]);
            S = I
        }
    ...
    Array.isArray(t) || (t = (t = t.split(/[,\s]/).reduce((function(t, e) {
        ...
        for (var d = 1; d < t.length; d++) {
            ...
            if (p && c && c.length > 2 && "L" == g[0] && p.length > 2 && "L" == p[0]) {
                var u, f, m = o(c),
                    C = o(g),
                    O = o(p);
                r ? (u = a(C, c.origPoint || m, e), f = a(C, p.origPoint || O, e)) : (u = i(C, m, e), f = i(C, O, e)), n(g, u), g.origPoint = C, l.push(g);
                var b = a(u, C, .5),
                    v = a(C, f, .5),
    ...
    this.element = t, this.requestParams = r, this.config = e, this.onSetViewBoxCallback = i, this.onDrawCallback = a, this.position = 0, this.bar = null, this._event_id = OrgChart._guid()
    ...
    if ((this.config.mouseScrool == OrgChart.action.xScroll || this.config.mouseScrool == OrgChart.action.scroll) && this.bar) {
        ...
        ! function(t, i, a) {
            ...
            function o() {
                ...
                Math.ceil(e.bar.scrollLeft) == Math.ceil(e.position) ? n = !1 : (e.bar.scrollLeft += t, l(o))
            }
            t.addEventListener("wheel", (function(t) {
                ...
                a = -a, a = Math.max(-1, Math.min(1, a)), e.position += -a * i;
    ...
    if (this.bar) {
        ...
        var a = (parseFloat(this.innerBar.clientWidth) - parseFloat(this.bar.clientWidth)) / 100,
            n = i * a;
        this.bar.ignore = !0, this.bar.scrollLeft = n, this.position = this.bar.scrollLeft, this.bar.style.visibility = a <= 0 ? "hidden" : "", this.config.showXScroll !== OrgChart.scroll.visible && (this.bar.style.visibility = "hidden"), OrgChart.events.publish("change", [this, {
    ...
    if ((this.config.mouseScrool == OrgChart.action.yScroll || this.config.mouseScrool == OrgChart.action.scroll) && this.bar) {
        ...
        ! function(t, i, a) {
            ...
            function o() {
                ...
                Math.ceil(e.bar.scrollTop) == Math.ceil(e.position) ? n = !1 : (e.bar.scrollTop += t, l(o))
            }
            t.addEventListener("wheel", (function(t) {
                if (t.ctrlKey) return;
                var a = 0;
    ...
    if (this.bar) {
        ...
        var a = (parseFloat(this.innerBar.clientHeight) - parseFloat(this.bar.clientHeight)) / 100,
            n = i * a;
        this.bar.ignore = !0, this.bar.scrollTop = n, this.position = this.bar.scrollTop, this.bar.style.visibility = a <= 0 ? "hidden" : "", this.config.showYScroll !== OrgChart.scroll.visible && (this.bar.style.visibility = "hidden"), OrgChart.events.publish("change", [this, {
            isScrollBarVisible: "hidden" != this.bar.style.visibility
        }])
    }
    ...
    l.value = e.format, s.value = e.landscape, h.value = e.scale, d.value = e.margin, c.value = e.header, g.value = e.footer, OrgChart.animate(t.element.querySelector("#boc-ppdf-btns"), {
        margin: [0, 0, 0, -250]
    }, {
        margin: [0, 0, 0, 0]
    }, 300, OrgChart.anim.outSin, (function() {
    ...
    return n && (d += '<div id="boc-header" style="width:' + i + "px;color:#757575;position:absolute;left:" + r.margin[3] + 'px;top:0;">' + n + "</div>"), d += t, o && (d += '<div id="boc-footer" style="width:' + i + "px;color:#757575;position:absolute;left:" + r.margin[3] + 'px;bottom:0;">' + o + "</div>"), d += "</div>", d += "</body></html>"
    ...
    for (var r = "", i = 0; i < this.config.clinks.length; i++) {
        ...
        if (n && -1 != e.res.visibleNodeIds.indexOf(n.id) && (o && -1 != e.res.visibleNodeIds.indexOf(o.id))) {
            ...
            switch (this.config.orientation) {
                case OrgChart.orientation.top:
                case OrgChart.orientation.top_left:
                    p <= u ? (C = 1, c.x = p + n.w / 10, g.x = u - o.w / 10) : (C = -1, c.x = p - n.w / 10, g.x = u + o.w / 10), s == d ? (C = 1, c.y = s, g.y = d) : s > d ? (c.y = s, g.y = d + o.h) : (c.y = s + n.h, g.y = d);
                    break;
                case OrgChart.orientation.bottom:
                case OrgChart.orientation.bottom_left:
                    p <= u ? (C = -1, c.x = p + n.w / 10, g.x = u + o.w / 10) : (C = 1, c.x = p - n.w / 10, g.x = u + o.w / 10), s == d ? (C = -1, c.y = s + n.h, g.y = d + o.h) : s > d ? (c.y = s, g.y = d + o.h) : (c.y = s + n.h, g.y = d);
                    break;
                case OrgChart.orientation.left:
                case OrgChart.orientation.left_top:
                    f <= m ? (C = -1, c.y = f + n.h / 5, g.y = m + o.h / 5) : (C = 1, c.y = f - n.h / 5, g.y = m + o.h / 5), l == h ? (C = -1, c.x = l, g.x = h) : l > h ? (c.x = l, g.x = h + o.w) : (c.x = l + n.w, g.x = h);
                    break;
                case OrgChart.orientation.right:
                case OrgChart.orientation.right_top:
                    f <= m ? (C = 1, c.y = f + n.h / 5, g.y = m + o.h / 5) : (C = -1, c.y = f - n.h / 5, g.y = m + o.h / 5), l == h ? (C = 1, c.x = l + n.w, g.x = h + o.w) : l > h ? (c.x = l, g.x = h + o.w) : (c.x = l + n.w, g.x = h)
            }
            var O = _(c, g, C),
                b = a.template;
            b || (b = "orange");
            ...
            var x = "M" + c.x + "," + c.y + "C" + c.x + "," + c.y + " " + O.x + "," + O.y + " " + g.x + "," + g.y;
            r += ("<g " + OrgChart.attr.c_link_from + '="{from}" ' + OrgChart.attr.c_link_to + '="{to}">').replace("{from}", n.id).replace("{to}", o.id) + v.link.replaceAll("{d}", x) + '<path stroke="transparent" stroke-width="15" fill="none" d="' + x + '" />', r += OrgChart.grCloseTag
        }
        ...
        function _(t, e, r) {
            ...
            return o = o / (Math.sqrt(i * i + n * n) * r) * OrgChart.clinkCurve(a), {
                x: t.x + i / 2 - n * o,
                y: t.y + n / 2 + i * o
            }
        }
    ...
    return this.config.clinks.push({
        ...
        label: r,
        template: i
    }), OrgChart.events.publish("updated", [this]), this
    ...
    function n(e, n, o) {
        ...
        if (e.sl == n.sl) switch (h = n, g.orientation) {
            ...
            for (; null == h;) {
                var O = !1,
                    ...
                    v = b.leftNeighbor,
                    y = b.rightNeighbor;
                if (b.id == n.id ? h = b : OrgChart._intersects(b, f, g) && (f = OrgChart._addPoint(b, s, g, f, d), O = !0), b.id != n.id) {
                    for (; v;) {
                        if (v.id == n.id) {
                            h = v;
                            break
                        }
                        OrgChart._intersects(v, f, g) && (f = OrgChart._addPoint(v, s, g, f, d), O = !0), v = v.leftNeighbor
                    }
                    for (; y;) {
                        if (y.id == n.id) {
                            h = y;
                        ...
                        OrgChart._intersects(y, f, g) && (f = OrgChart._addPoint(y, s, g, f, d), O = !0), y = y.rightNeighbor
                    }
                }
                if (!O) {
                    var x = s[s.length - 1][0],
                        _ = 0;
                    if (b.parent) {
                        u = g.levelSeparation, b.parent.layout && (u = g.mixedHierarchyNodesSeparation);
        ...
        var U = e.id,
            R = n.id;
        o && (U = n.id, R = e.id), r += ("<g " + OrgChart.attr.s_link_from + '="{from}" ' + OrgChart.attr.s_link_to + '="{to}">').replace("{from}", U).replace("{to}", R) + p.link.replaceAll("{d}", E) + '<path stroke="transparent" stroke-width="15" fill="none" d="' + E + '" />', r += OrgChart.grCloseTag
    }
    ...
    if (e.node && e.node.tags && e.node.tags.has("group-dotted-lines")) {
        var r = t.getScale(),
            ...
            a = "";
        e.node.min ? (i.nodeGroupDottedOpenButton || console.error(`[${e.node.templateName}].nodeGroupDottedOpenButton is not defined`), a += `<g style="cursor:pointer;"  data-ctrl-n-dotted-open="${e.node.id}" transform="matrix(1,0,0,1,${e.node.x},${e.node.y})">`, a += i.nodeGroupDottedOpenButton) : (i.nodeGroupDottedCloseButton || console.error(`[${e.node.templateName}].nodeGroupDottedCloseButton is not defined`), a += `<g style="cursor:pointer;" transform="matrix(1,0,0,1,${e.node.x},${e.node.y})" data-ctrl-n-dotted-close="${e.node.id}">`, a += i.nodeGroupDottedCloseButton), a = (a += "</g>").replaceAll("{cw}", e.node.w / 2).replaceAll("{ch}", e.node.h / 2).replaceAll("{ew}", e.node.w - (e.node.padding ? e.node.padding[1] : 0)).replaceAll("{eh}", e.node.h - (e.node.padding ? e.node.padding[2] : 0));
    ...
    if (t.config.groupDottedLines.length) {
        for (var r = t.element.querySelectorAll("[data-ctrl-n-dotted-close]"), i = 0; i < r.length; i++) r[i].addEventListener("click", (function() {
...
})), void 0 === OrgChart && (OrgChart = {}), OrgChart.prototype.undo = function(t) {
    if (this.config.undoRedoStorageName) {
        ...
        if (0 != e) {
            ...
            var a = JSON.parse(i);
            this.config.nodes = a.nodes, this.config.clinks = a.clinks, this.config.slinks = a.slinks, this.config.groupDottedLines = a.groupDottedLines, this.config.dottedLines = a.dottedLines, OrgChart.events.publish("updated", [this]), this.filterUI.update(), this.draw(OrgChart.action.update, void 0, t), this.undoRedoUI.refresh()
        }
    }
...
}, void 0 === OrgChart && (OrgChart = {}), OrgChart.undoRedoUI = function() {
    ...
    if (this.instance.config.undoRedoStorageName) {
        ...
        if (!1 !== OrgChart.events.publish("change", [this, e])) {
            ...
            if (!r || !i) {
                var a = document.createElement("div");
                a.classList.add("boc-undo-redo"), a.innerHTML = `<span data-undo>${OrgChart.icon.undo(50,50,"")}<span class="boc-undo-i"></span></span>\n                            <span data-redo>${OrgChart.icon.redo(50,50,"")}<span class="boc-redo-i"></span></span>`, this.instance.element.appendChild(a), r = this.instance.element.querySelector("[data-undo]"), i = this.instance.element.querySelector("[data-redo]"), r.addEventListener("click", (function() {
                    t.instance.undo()
                })), i.addEventListener("click", (function() {
                    t.instance.redo()
                }))
            }
            e.undoStepsCount > 0 ? (r.classList.add("boc-ur-clickable"), r.querySelector(".boc-undo-i").innerHTML = e.undoStepsCount, r.querySelector(".boc-undo-i").style.display = "inline-block") : (r.classList.remove("boc-ur-clickable"), r.querySelector(".boc-undo-i").style.display = "none"), e.redoStepsCount > 0 ? (i.classList.add("boc-ur-clickable"), i.querySelector(".boc-redo-i").innerHTML = e.redoStepsCount, i.querySelector(".boc-redo-i").style.display = "inline-block") : (i.classList.remove("boc-ur-clickable"), i.querySelector(".boc-redo-i").style.display = "none")
        }
    }
        ...
        if (t.manager.action != OrgChart.action.move) {
            ...
            l.onmousedown = function(t) {
                var e, n, o, h = l.getBoundingClientRect(),
                    d = h.left,
                    c = h.top;
                if (i = parseInt(t.clientX - d), a = parseInt(t.clientY - c), e = a, n = (i - OrgChart.miniMap._settings._translateX) / OrgChart.miniMap._settings._scale, o = (e - OrgChart.miniMap._settings._translateY) / OrgChart.miniMap._settings._scale, n > r[0] && n < r[0] + r[2] && o > r[1] && o < r[1] + r[3]) return t.preventDefault(), t.stopPropagation(), void(s = !0)
            }, l.onmousemove = function(e) {
                if (s) {
                    e.preventDefault(), e.stopPropagation(), OrgChart.miniMap._mouseMove = !0;
                ...
                s && (t.preventDefault(), t.stopPropagation(), s = !1, OrgChart.miniMap._mouseMove = !1)
            }, l.onclick = function(e) {
                if (e.preventDefault(), e.stopPropagation(), OrgChart.miniMap._mouseMove) OrgChart.miniMap._mouseMove = !1;
                else {
                    ...
                    r[0] = d - (r[0] + r[2] - r[0]) / 2 - OrgChart.miniMap._settings._translateX / OrgChart.miniMap._settings._scale, r[1] = c - (r[1] + r[3] - r[1]) / 2 - OrgChart.miniMap._settings._translateY / OrgChart.miniMap._settings._scale, t.setViewBox(r), h && (clearTimeout(h), h = null), h = setTimeout((function() {
                        t._draw(!0, OrgChart.action.move)
                    }), 300), OrgChart.miniMap._drawRectSelectorCanvas(t, r)
                }
            }
        }
    } else {
                ...
                if (null != (e = OrgChart._search.searchAndComputeScore(h, m, f, n))) {
                    ...
                    if (c[C]) {
                        if (c[C] && c[C] < e.__score) {
                            c[C] = e.__score;
                            for (var O = l.length - 1; O >= 0; O--) l[O].id == C && l.splice(O, 1);
    ...
    for (p = n.length - 1; p >= 0; p--)
        for (c = 0; c < n.length; c++) c < p && n[c].start + n[c].length > n[p].start && n.splice(p, 1);
    var b = e;
    for (p = n.length - 1; p >= 0; p--) b = (b = b.insert(n[p].start + n[p].length, "</mark>")).insert(n[p].start, "<mark>");
    return {
        __searchMarks: b,
        __score: O
    }
    ...
    if (t) {
        ...
        if (t.readFromUrlParams) {
            ...
            if (n.has(a.paramScale) && n.has(a.paramX) && n.has(a.paramY) && n.has(a.paramExp) && n.has(a.paramMin) && n.has(a.paramAdjustify)) {
                ...
                (c = [])[0] = s, c[1] = h, c[2] = e / l, c[3] = r / l, o.vb = c, o.scale = l, o.x = s, o.y = h, o.roots = null, n.has(a.paramRoots) && (o.roots = n.get(a.paramRoots).split("*")), o.exp = n.get(a.paramExp).split("*"), o.min = n.get(a.paramMin).split("*");
    ...
    if (this.instance.config.filterBy) {
        ...
        if ("all" == this.instance.config.filterBy)
            for (var e = OrgChart.manager.getAllFields(this.instance.config), r = 0; r < e.length; r++) {
                ...
                for (r = 0; r < this.instance.config.filterBy.length; r++) t[this.instance.config.filterBy[r]] = {};
        ...
        if (null != this.filterBy)
            for (var s in t)
                if (this.filterBy[s])
                    for (var h in t[s]) this.filterBy[s][h] && (t[s][h] = this.filterBy[s][h]);
        this.filterBy = t;
        var d = this;
        ...
        for (var s in this.filterBy) {
                ...
                var g = {
                    name: s,
                    html: `<div data-filter-field="${s}"><span onclick="this.parentNode.click()"  class="filter-text">${s}</span></div>`
                };
                OrgChart.events.publish("add-filter", [d, g]);
                c += g.html;
  ...
  this.element.innerHTML = `<div>${c}</div>`;
        ...
        this.element.addEventListener("click", (function(t) {
            ...
            if (t.target.hasAttribute("data-filter-close") || t.target.hasAttribute("data-filter-field")) {
                ...
                var totalCount = 0;
                var filterField = t.target.getAttribute('data-filter-field');

                
                for (var i = 0; i < d.instance.config.nodes.length; i++){
                    var data = d.instance.config.nodes[i]; 
                ...
                if (!o ) {
                    var l = {
                        ...
                        checked: !0,
                        html: `<div>\n
                        <input data-all-search type="checkbox" id="all-search-${e}" name="all-search-${e}" checked>\n
                        <label for="all-search-${e}">[All]</label>\n
                      </div>`
                    };
                    ...
                    for (var h in d.filterBy[e]) {
                        ...
                        var g = c.text || "Hide/Show Departments";
                    
                        if (g === "Hide/Show Departments") {
                            var l = {
                                name: e,
                                text: g,
                                value: h,
                            ...
                            OrgChart.events.publish("add-item", [d, l]), s += l.html
                        }
                    }
                  
                    for (var h in d.filterBy[e]) {
                            var c = d.filterBy[e][h],
                            g = c.text || "Hide/Show Departments";
                    ...
                    (o = document.createElement("div")).innerHTML = `<fieldset>\n<legend>Filter by ${e}:</legend>\n<input type="text" id="filter-search" placeholder="Search...">${s}\n                                                </fieldset>`, o.setAttribute("data-filter-menu", e), o.classList.add("boc-filter-menu"), t.target.appendChild(o); 
                    totalCount = 0;
                    const searchInput = o.querySelector('#filter-search');
            searchInput.addEventListener('input', () => {


                const searchTerm = searchInput.value.toLowerCase();

                const checkboxes = o.querySelectorAll('input[type="checkbox"]');
                const selectAllSearchCheckbox = o.querySelector('input[data-all-search]');
                for (const checkbox of checkboxes) {
                    const label = checkbox.parentElement.querySelector('label');
                    const labelText = label ? label.textContent.toLowerCase() : '';
                    selectAllSearchCheckbox.parentElement.style.display = 'block';
                    checkbox.parentElement.style.display = labelText.includes(searchTerm) ? 'block' : 'none';
                }
                    ...
                    for (i = 0; i < p.length; i++) p[i].addEventListener("change", (function(t) {
                        ...
                        if (e) {
                            ...
                            if (t.target.hasAttribute("data-all-search")) {
                                var q = Array.from(p).filter(checkbox => checkbox.parentElement.style.display !== 'none');
                                const isChecked = this.checked;
                                
                                for (var a = 0; a < p.length; a++){
                                                
                                    if (p[a] != t.target && p[a].type=='checkbox') {
                                        
                                        p[a].checked = isChecked;
                                        ...
                                        for (var n in d.filterBy[r]) {
                                           
                                            d.filterBy[r][n].checked = false;
                                            
                                            var filter = false;
                                            for (var a = 0; a < q.length; a++){
                                                
                                                if (q[a] != t.target && q[a].name == n) {
                                                    q[a].checked = isChecked;
                                                    filter = true;  
                                                }
                                                
                                            }
                                            if(filter){
                                            d.filterBy[r][n].checked = isChecked;
                            ...
                            if (r=='Department'){
                                node_obj = chart.nodes[l]
                                data = chart.get(node_obj.id)
                                
                                if( data && data['Category Type']=='Department' && q[a].name == data['Department']) {
                                        if (node_obj.childrenIds.length){
                                            for (var j = 0; j < node_obj.childrenIds.length; j++) {
                                                    var cnode = chart.nodes[node_obj.childrenIds[j]];
                                                    
                                                    applyTemplateRecursively(cnode, chart, isChecked);
                            ...
                            else if (r!='Education 1' &&  null != d.filterBy[r][this.name] && (d.filterBy[r][this.name].checked = this.checked), this.checked)
                            console.log()    
                            for (var o = d.instance.config.nodes, l = 0; l < o.length; l++)
                                    if (r=='Department'){
                                            node_obj = chart.nodes[l]
                                            ...
                                            const ischecked = this.checked;
                                            if(data)
                                            if (data['Category Type']=='Department' && this.name == data['Department']){
                                                if (node_obj.childrenIds.length){
            ...
            data = chart.get(node_obj.id)
            if(data)
            if (data['Category Type']=='Person' && this.name == data.name){
            var educational_institute1 = data['Education 1']; 
            var educational_institute2 = data['Education 2'];
            var educational_institute3 = data['Education 3'];
            var past_company1 = data['Previous Company 1'];
            var past_company2 = data['Previous Company 2'];
            var past_company3 = data['Previous Company 3'];
            var past_company4 = data['Previous Company 4'];
            var past_company5 = data['Previous Company 5'];        
                }   
                for (var y = d.instance.config.nodes, x = 0; x < y.length; x++) {
                    var node_obj = chart.nodes[x];
                    var data = chart.get(node_obj.id);
                    if (data && data['Category Type'] == 'Person') {
                        var matchFound = false; 
                        [educational_institute1, educational_institute2, educational_institute3, past_company1, past_company2, past_company3, past_company4, past_company5].forEach(function(variable) {
                            if (!matchFound && variable !== '') {
                                
                            for (var i = 1; i <= 3; i++) { 
                                var attributeName = "Education" + i;
                                if (data[attributeName] === variable) {
                                    d.filterBy['name'][data.name].checked = t.target.checked;
                                    matchFound = true;
                                    break; 
                                }}
                            for (var i = 1; i <= 5; i++) {
                                var attributeName = "Previous Company" + i;
                                if (data[attributeName] === variable) {
                                    d.filterBy['name'][data.name].checked = t.target.checked;
                                    matchFound = true;
                                    break; 
                        ...
                        if (matchFound) {
                            continue; }}}}
                                        ...
                                        else if (o[l][r] == this.name)
                                        for (var s = o[l]; s;)
                                        if (OrgChart.isNEU(s.stpid)) {
                                            if (OrgChart.isNEU(s.pid)) {
                                                s = null;
                                            } else {
                                                
                                                s = d.instance._get(s.pid);
                                ...
                                if (h) {
                                    ...
                                    console.error('Cannot find element with selector: [name="' + s[r] + '"]');
                                }                            }
                            d.instance.draw()
                        }
...
function applyTemplateRecursively(cnode, chart, ischecked) {
    

              cdata = chart.get(cnode.id)

                if (cdata && cdata['Department']) {
                    var childCheckbox = document.querySelector('[name="' + cdata['Department'] + '"]');
                    if (childCheckbox) {
                        childCheckbox.checked = ischecked;
                        d.filterBy['Department'][cdata['Department']].checked = ischecked;
             
              }}
               if (cdata && cdata['Designation']){
                var childCheckbox = document.querySelector('[name="' + cdata["Designation"] + '"]');
                    if (childCheckbox) {
                        childCheckbox.checked = ischecked;
                        d.filterBy['Designation'][cdata['Designation']].checked = ischecked;
                    }
              }
               if (cdata && cdata['City/Town']){
                var childCheckbox = document.querySelector('[name="' + cdata["City/Town"] + '"]');
               ...
               if (cdata && cdata['State/Province']){
                var childCheckbox = document.querySelector('[name="' + cdata["State/Province"] + '"]');
               ...
               if (cdata && cdata['Country/Region']){
                var childCheckbox = document.querySelector('[name="' + cdata["Country/Region"] + '"]');
               ...
               if (cdata && cdata['Seniority Level']){
                var childCheckbox = document.querySelector('[name="' + cdata["Seniority Level"] + '"]');
                ...
                if (cdata && cdata['Job Function']){
                    var childCheckbox = document.querySelector('[name="' + cdata["Job Function"] + '"]');
           ...
           for (var j = 0; j < cnode.childrenIds.length; j++) {
              var childnode = chart.nodes[cnode.childrenIds[j]];
              
              applyTemplateRecursively(childnode, chart, ischecked);
          
          }
            } 

            
                o.style.display="block",t.target.classList.add("filter-field-selected"), (n = document.createElement("div")).classList.add("close"), n.innerHTML = "x", n.setAttribute("data-filter-close", ""), o.parentNode.insertBefore(n,o), n.style.display="inline-block",n.style.margin="0px 0px 0px 20px",n.style.fontSize="large",n.style.fontWeight="bold", OrgChart.events.publish("show-items", [d, {
                    name: e
    }])
            }
        ...
        this.instance.element.appendChild(this.element), OrgChart.events.publish("update", [this, {}])
...
OrgChart.filterUI.prototype.on = function(t, e) {
    return OrgChart.events.on(t, e, this._event_id), this
}, OrgChart.filterUI.textFilterBy = "Filter by", OrgChart.filterUI.all = "[All]", void 0 === OrgChart && (OrgChart = {});
void 0 === OrgChart.remote && (OrgChart.remote = {}), OrgChart.LIMIT_NODES = !0, OrgChart.remote._fromResDTO = function(t, e, r, i, a) {
    var n = e[t.id];
